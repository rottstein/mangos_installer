...
def loadPreDefines(self):
    self.install_dir='/home/USER/mangos/Cataclysm' # Path to install
    self.q_data_dir='/home/USER/mangos/Data'       # Path to Data folder (DBC/MAPS/VMAPS)
    ...
    self.q_pass='xxxxxx'                           # Database password
